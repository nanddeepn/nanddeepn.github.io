...
categories:
  - Google API
header:
  image: media/2019-01-14-google-fit-rest-api-overview/01.png
  teaser: media/2019-01-14-google-fit-rest-api-overview/01.png
tags:
  - "2019"
  - January 2019
last_modified_at: 2019-01-14T00:00:00-00:00
---
...
![](/media/2019-01-14-google-fit-rest-api-overview/01.png)
...
- **Data Type:** Represents the schema for the data being recorded. It only defines representation and format of data. As an example com.google.step_count.delta data type represents step count as delta between start and end time, whereas ```com.google.step_count.cumulative``` as sum of steps between start and end time.
