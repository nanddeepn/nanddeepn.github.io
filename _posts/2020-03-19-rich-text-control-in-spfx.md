...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/04/word-image.png)
...
1. Implement onInit method to initialize the context.
...
1. Set or update the state as user types in the input.
...
1. On the “Save” button click, add an item to the SharePoint list.
...
1. Implement the _onRead_ method to read the first item from the SharePoint list.
...
1. Implement the _onUpdate_ method to update the first item in the SharePoint list.
