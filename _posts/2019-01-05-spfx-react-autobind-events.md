...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-294.png)
...
1. Define textbox and button controls.
...
1. Define button click event.

private greetButtonClicked(): void {  
    alert("Hello " + this.state.userText);  
}

1. Define constructor to set the initial state.
...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-295.png)
...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-296.png)
...
1. Remove any bindings from Constructor.
2. Decorate event with @autobind.
