...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-421.png)
...
1. Update the interface IPreallocateSpaceApplicationCustomizerProperties to include Top property.

export interface IPreallocateSpaceApplicationCustomizerProperties {  
  Top: string;  
}

1. Implement the OnInit method.
...
1. Implement \_renderPlaceHolders method.
...
2. Refresh the SharePoint site. You will observe the movement of the page (flickering).
...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-422.png)
