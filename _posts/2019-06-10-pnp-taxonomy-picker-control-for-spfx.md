...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-391.png)
...
1. Open React component properties at “src\\webparts\\pnPTaxonomyPicker\\components\\IPnPTaxonomyPickerProps.ts”
...
1. From our web part (src\\webparts\\pnPTaxonomyPicker\\PnPTaxonomyPickerWebPart.ts) pass the context to React component.
...
1. Use the TaxonomyPicker control in the render method as follows.
...
1. Implement onChange property to get the selected terms from the TaxonomyPicker.
...
1. Implement addSelectedTerms method.
...
private addSelectedTerms(): void {   
  ...
  sp.web.lists.getByTitle("SPFx Users").items.add({  
    Title: getGUID(),  
    FirstTerm: {   
      \_\_metadata: { "type": "SP.Taxonomy.TaxonomyFieldValue" },  
  ...
  // If the name of your taxonomy field is SomeMultiValueTaxonomyField, the name of your note field will be SomeMultiValueTaxonomyField\_0  
  const multiTermNoteFieldName = 'Terms\_0';  
...
Set “Allow multiple values” to No

Terms

Managed Metadata

Set “Allow multiple values” to Yes
...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-392.png)

1. The selected terms should get added to the SharePoint list.

![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-393.png)
...
- PnP Taxonomy Picker ([https://sharepoint.github.io/sp-dev-fx-controls-react/controls/TaxonomyPicker/](https://sharepoint.github.io/sp-dev-fx-controls-react/controls/TaxonomyPicker/))
