...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-312.png)
...
1. Run Yeoman SharePoint Generator to create the solution using --plusbeta option, as the library component type is still in preview (beta) mode.

yo @microsoft/sharepoint --plusbeta

1. Yeoman generator will present you with the wizard by asking questions about the solution to be created.

![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-313.png)
...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-314.png)
...
1. Open manifest.json (src\\CommonLibraryLibrary.manifest.json) to verify the library component.
...
1. The library component type is listed in index.ts file referencing to our library class.

![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-315.png)

1. Open src\\commonLibrary\\CommonLibraryLibrary.ts
2. The library component has default method name, which simply returns the name of library component. Let’s implement our own method.
...
1. On the command prompt, type gulp to verify the library code compiles without any error.
...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-316.png)

This will create a local npm link to the library.

1. Create a web part project in a separate project folder, not in library project folder structure.
2. On the command prompt type below command.

yo @microsoft/sharepoint

![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-317.png)
...
1. On the command prompt, navigate to the root of new web part folder (i.e. \\src\\webparts\\libraryConsumerWebPart) and run below command.

npm link spfx-library-component-beta

![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-318.png)

1. On the command prompt type below command to open the solution in code editor of your choice.

code .

1. From the web part solution, open the web part file src\\webparts\\libraryConsumerWebPart\\LibraryConsumerWebPartWebPart.ts
2. Import the library to use.
...
![](https://nanddeepnachanblogs.com/wp-content/uploads/2020/03/word-image-319.png)
